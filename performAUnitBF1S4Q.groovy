def call(def input) {
	...
	def responseGET = httpRequest url: "http://wdflbmdX16752.wdf.sap.corp:50002/sap/bc/build/sync?", 
	...
	def responsePOST = httpRequest url: "http://wdflbmdX16752.wdf.sap.corp:50002/sap/bc/build/sync?trkorr=${input}&phase=AUNIT&pipeline_build_id=${pipelinename}",
					     authentication: 'Build', 
						 httpMode: 'POST', 
